...
const CalendarHeader = ({
  ...
  return (
    <nav
      className="relative mt-3 sm:mt-4 mx-2 mb-3 sm:mb-4 bg-white/60 dark:bg-white/10 backdrop-blur-md rounded-2xl sm:rounded-3xl border border-white/20 dark:border-white/10 shadow-lg"
      role="navigation"
    ...
    >
      ...
      <div className="hidden lg:flex items-center justify-between p-3 sm:p-4">
        ...
        <Button
          ...
          className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white border-0 shadow-lg hover:shadow-xl transition-all duration-300 px-4 py-2 h-auto rounded-xl"
        >
