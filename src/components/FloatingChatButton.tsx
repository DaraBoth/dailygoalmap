...
const FloatingChatButton: React.FC<FloatingChatButtonProps> = ({ onGoalDataGenerated }) => {
  ...
  return (
    <>
      ...
      <motion.button
        className="fixed bottom-24 right-6 h-14 w-14 rounded-full bg-zinc-950/80 backdrop-blur-xl border border-white/10 text-white shadow-2xl z-40 hover:scale-110 transition-all duration-300 flex items-center justify-center group overflow-hidden"
