...
export const GoalChatWidgetN8N: React.FC<GoalChatWidgetProps> = ({ goalId, userInfo }) => {
  ...
  return (
    <>
      <motion.button
        className={`fixed ${isMobile ? 'bottom-6 left-6' : 'bottom-24 right-6'} h-14 w-14 rounded-full bg-primary/90 backdrop-blur-xl border border-primary/20 text-primary-foreground shadow-2xl z-50 hover:scale-110 transition-all duration-300 flex items-center justify-center p-0 overflow-hidden group`}
